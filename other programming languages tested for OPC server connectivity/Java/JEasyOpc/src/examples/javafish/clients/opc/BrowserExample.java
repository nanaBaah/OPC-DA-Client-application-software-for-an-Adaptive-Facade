...
public class BrowserExample {
  ...
  public static void main(String[] args) {
    ...
    JOpcBrowser jbrowser = new JOpcBrowser("localhost", "WMaEIBOPCServer", "JOPCBrowser1");
    ...
    try {
      String[] items = jbrowser.getOpcItems("CommonData.WeatherData_Research.0/3/21", true);
      if (items != null) {
